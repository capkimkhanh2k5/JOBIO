...
class TestLoginUserService(TestCase):
    ...
    def test_login_success(self):
        ...
        login_input = LoginInput(email="active@example.com", password="password123")
    ...
    def test_login_wrong_email(self):
        ...
        login_input = LoginInput(email="notexist@example.com", password="password123")
    ...
    def test_login_wrong_password(self):
        ...
        login_input = LoginInput(email="active@example.com", password="wrongpassword")
    ...
    def test_login_inactive_user(self):
        ...
        login_input = LoginInput(email="inactive@example.com", password="password123")
