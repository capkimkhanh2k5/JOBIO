...
class TestRefreshTokenEdgeCases(APITestCase):
    ...
    def test_refresh_token_with_invalid_token(self):
        ...
        response = self.client.post(
            AUTH_REFRESH_TOKEN, {"refresh": "invalid_token_here"}
        )
...
class TestVerifyEmailEdgeCases(APITestCase):
    ...
    def test_verify_email_with_invalid_token(self):
        ...
        response = self.client.post(
            AUTH_VERIFY_EMAIL, {"email_verification_token": "invalid_token_not_exist"}
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_verify_email_with_empty_token(self):
        ...
        response = self.client.post(AUTH_VERIFY_EMAIL, {"email_verification_token": ""})
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_verify_email_already_verified(self):
        ...
        response1 = self.client.post(
            AUTH_VERIFY_EMAIL, {"email_verification_token": token}
        )
...
class TestResendVerificationEdgeCases(APITestCase):
    ...
    def test_resend_verification_email_not_exist(self):
        ...
        response = self.client.post(
            AUTH_RESEND_VERIFICATION, {"email": "notexist@example.com"}
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertIn("detail", response.data)
    ...
    def test_resend_verification_email_already_verified(self):
        ...
        response = self.client.post(
            AUTH_RESEND_VERIFICATION, {"email": self.verified_user.email}
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertIn("detail", response.data)
...
class TestForgotPasswordEdgeCases(APITestCase):
    ...
    def test_forgot_password_invalid_email_format(self):
        ...
        response = self.client.post(
            AUTH_FORGOT_PASSWORD, {"email": "invalid-email-format"}
        )
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
