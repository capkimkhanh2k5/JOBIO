...
class Report(models.Model):
    ...
    entity_type = models.CharField(
        max_length=50, db_index=True, verbose_name="Loại đối tượng"
    )
    entity_id = models.IntegerField(db_index=True, verbose_name="ID đối tượng")
    ...
    resolution_notes = models.TextField(
        null=True, blank=True, verbose_name="Ghi chú xử lý"
    )
