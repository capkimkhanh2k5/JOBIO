...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        self.stdout.write(self.style.NOTICE('Starting to seed master data from JSON files...'))
    ...
    def _seed_benefit_categories(self, data):
        ...
        self.stdout.write(self.style.SUCCESS(f'  ✓ BenefitCategories: {len(objs)} records'))
    ...
    def _seed_skill_categories(self, data):
        ...
        self.stdout.write(self.style.SUCCESS(f'  ✓ SkillCategories: {len(objs)} records'))
    ...
    def _seed_payment_methods(self, data):
        ...
        self.stdout.write(self.style.SUCCESS(f'  ✓ PaymentMethods: {len(objs)} records'))
