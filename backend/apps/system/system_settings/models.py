...
class SystemSetting(models.Model):
    ...
    setting_key = models.CharField(
        max_length=100, unique=True, db_index=True, verbose_name="Khóa"
    )
    setting_value = models.TextField(null=True, blank=True, verbose_name="Giá trị")
    ...
    category = models.CharField(
        max_length=50, null=True, blank=True, db_index=True, verbose_name="Danh mục"
    )
