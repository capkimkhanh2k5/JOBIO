...
class FileUpload(models.Model):
    ...
    file_type = models.CharField(
        max_length=50, null=True, blank=True, verbose_name="Loại file"
    )
    file_size = models.IntegerField(
        null=True, blank=True, verbose_name="Kích thước (bytes)"
    )
    mime_type = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="MIME type"
    )
    entity_type = models.CharField(
        max_length=50, null=True, blank=True, verbose_name="Loại đối tượng"
    )
