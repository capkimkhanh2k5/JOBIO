...
urlpatterns = [
    ...
    path(
        "stats/", ApplicationViewSet.as_view({"get": "stats"}), name="application-stats"
    ),
    path(
        "bulk-action/",
        ApplicationViewSet.as_view({"post": "bulk_action_view"}),
        name="application-bulk-action",
    ),
    path(
        "export/",
        ApplicationViewSet.as_view({"get": "export"}),
        name="application-export",
    ),
    # Then pk-based routes
    path(
        "<int:pk>/status/",
        ApplicationViewSet.as_view({"patch": "change_status"}),
        name="application-status",
    ),
    path(
        "<int:pk>/rating/",
        ApplicationViewSet.as_view({"patch": "rate"}),
        name="application-rating",
    ),
    path(
        "<int:pk>/notes/",
        ApplicationViewSet.as_view({"post": "add_notes"}),
        name="application-notes",
    ),
    path(
        "<int:pk>/history/",
        ApplicationViewSet.as_view({"get": "history"}),
        name="application-history",
    ),
    path(
        "<int:pk>/shortlist/",
        ApplicationViewSet.as_view({"post": "shortlist"}),
    ...
    path(
        "<int:pk>/offer/",
        ApplicationViewSet.as_view({"post": "offer"}),
        name="application-offer",
    ),
    path(
        "<int:pk>/withdraw/",
        ApplicationViewSet.as_view({"post": "applicant_withdraw"}),
        name="application-withdraw",
    ),
    path(
        "<int:pk>/interviews/",
        ApplicationViewSet.as_view({"get": "list_interviews"}),
