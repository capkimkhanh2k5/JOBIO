...
class Interview(models.Model):
    ...
    scheduled_at = models.DateTimeField(
        db_index=True, verbose_name="Thời gian phỏng vấn"
    )
    ...
    meeting_link = models.URLField(
        max_length=500, null=True, blank=True, verbose_name="Link meeting"
    )
    ...
    role = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Vai trò"
    )
