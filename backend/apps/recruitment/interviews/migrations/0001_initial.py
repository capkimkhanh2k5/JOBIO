    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "round_number",
                    models.IntegerField(default=1, verbose_name="Vòng phỏng vấn"),
                ),
                (
                    "scheduled_at",
                ...
                (
                    "feedback",
                    models.TextField(blank=True, null=True, verbose_name="Nhận xét"),
                ),
                (
                    "result",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="interviews",
                        to="recruitment_interview_types.interviewtype",
