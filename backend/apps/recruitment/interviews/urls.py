...
urlpatterns = [
    ...
    path(
        "calendar/",
        InterviewViewSet.as_view({"get": "calendar"}),
    ...
    path(
        "<int:pk>/reschedule/",
        InterviewViewSet.as_view({"patch": "reschedule"}),
        name="interview-reschedule",
    ),
    path(
        "<int:pk>/cancel/",
        InterviewViewSet.as_view({"patch": "cancel"}),
        name="interview-cancel",
    ),
    path(
        "<int:pk>/complete/",
        InterviewViewSet.as_view({"patch": "complete"}),
        name="interview-complete",
    ),
    path(
        "<int:pk>/feedback/",
        InterviewViewSet.as_view({"post": "add_feedback"}),
        name="interview-feedback",
    ),
    path(
        "<int:pk>/send-reminder/",
        InterviewViewSet.as_view({"post": "send_reminder_action"}),
