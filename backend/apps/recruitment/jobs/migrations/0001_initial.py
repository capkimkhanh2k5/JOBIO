        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Kinh nghiệm tối đa (năm)"
                    ),
                ),
                (
                    "salary_min",
                ...
                (
                    "salary_currency",
                    models.CharField(
                        default="VND", max_length=10, verbose_name="Đơn vị tiền tệ"
                    ),
                ),
                (
                    "salary_type",
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Lương thỏa thuận"),
                ),
                (
                    "number_of_positions",
                    models.IntegerField(default=1, verbose_name="Số lượng tuyển"),
                ),
                ("description", models.TextField(verbose_name="Mô tả công việc")),
                ("requirements", models.TextField(verbose_name="Yêu cầu")),
                (
                    "benefits",
                    models.TextField(blank=True, null=True, verbose_name="Quyền lợi"),
                ),
                (
                    "is_remote",
                    models.BooleanField(default=False, verbose_name="Làm việc từ xa"),
                ),
                (
                ...
                (
                    "application_count",
                    models.IntegerField(default=0, verbose_name="Số đơn ứng tuyển"),
                ),
                (
                    "featured",
                ...
                (
                    "featured_until",
                    models.DateField(blank=True, null=True, verbose_name="Nổi bật đến"),
                ),
                (
                    "published_at",
                    models.DateTimeField(
                        blank=True, db_index=True, null=True, verbose_name="Ngày đăng"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="jobs",
                        to="recruitment_job_categories.jobcategory",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company", "status"], name="idx_jobs_company_status"
                    ),
                    models.Index(
