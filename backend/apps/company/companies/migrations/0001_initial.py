        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_name",
                    models.CharField(
                        db_index=True, max_length=255, verbose_name="Tên công ty"
                    ),
                ),
                (
                    "slug",
                ...
                (
                    "logo_url",
                    models.URLField(
                        blank=True, max_length=500, null=True, verbose_name="URL logo"
                    ),
                ),
                (
                    "banner_url",
                    models.URLField(
                        blank=True, max_length=500, null=True, verbose_name="URL banner"
                    ),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Thời gian xác minh"
                    ),
                ),
                (
                    "follower_count",
                    models.IntegerField(default=0, verbose_name="Số người theo dõi"),
                ),
                (
                    "job_count",
                    models.IntegerField(default=0, verbose_name="Số việc làm"),
                ),
                (
                    "created_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="companies",
                        to="company_industries.industry",
