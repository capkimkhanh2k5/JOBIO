...
class CompanyBenefitViewSet(viewsets.GenericViewSet):
    ...
    def create(self, request, company_pk=None):
        ...
        try:
            benefit = create_benefit(
                company, BenefitCreateInput(**serializer.validated_data)
            )
    ...
    def update(self, request, company_pk=None, pk=None):
        ...
        try:
            updated = update_benefit(
                benefit, BenefitUpdateInput(**serializer.validated_data)
            )
    ...
    def reorder(self, request, company_pk=None):
        ...
        try:
            benefits = reorder_benefits(
                company, serializer.validated_data["benefit_ids"]
            )
