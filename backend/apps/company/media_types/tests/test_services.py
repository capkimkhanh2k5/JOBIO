...
class TestMediaTypeServices(TestCase):
    ...
    def test_create_media_type_success(self):
        ...
        input_data = MediaTypeInput(
            type_name="Video", description="Video files (mp4, webm)", is_active=True
        )
    ...
    def test_create_media_type_without_description(self):
        ...
        input_data = MediaTypeInput(type_name="Audio", is_active=True)
    ...
    def test_update_media_type_all_fields(self):
        ...
        input_data = MediaTypeInput(
            type_name="Updated Name", description="Updated description", is_active=False
        )
    ...
    def test_delete_media_type_removes_from_db(self):
        ...
        self.assertEqual(
            MediaType.objects.count(), 2
        )  # setUp creates one too, so 1+2=3, delete 1 -> 2
