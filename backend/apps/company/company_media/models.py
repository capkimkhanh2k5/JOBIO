...
class CompanyMedia(models.Model):
    ...
    thumbnail_url = models.URLField(
        max_length=500, null=True, blank=True, verbose_name="URL thumbnail"
    )
    title = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="Tiêu đề"
    )
    caption = models.TextField(null=True, blank=True, verbose_name="Mô tả")
    ...
    def __str__(self):
        return (
            f"{self.company.company_name} - {self.title or self.media_type.type_name}"
        )
