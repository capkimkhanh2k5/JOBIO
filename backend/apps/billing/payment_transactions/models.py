...
class PaymentTransaction(models.Model):
    ...
    transaction_id = models.CharField(
        max_length=255, unique=True, null=True, blank=True, verbose_name="Mã giao dịch"
    )
    ...
    payment_gateway = models.CharField(
        max_length=50, null=True, blank=True, verbose_name="Cổng thanh toán"
    )
    gateway_response = models.JSONField(
        null=True, blank=True, verbose_name="Phản hồi từ cổng thanh toán"
    )
