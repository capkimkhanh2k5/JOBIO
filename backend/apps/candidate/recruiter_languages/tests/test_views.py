...
class RecruiterLanguageViewTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.lang_vi = Language.objects.create(
            language_code="vi", language_name="Vietnamese", is_active=True
        )
        self.lang_ja = Language.objects.create(
            language_code="ja", language_name="Japanese", is_active=True
        )
    ...
    def test_create_language_success(self):
        ...
        self.assertEqual(
            RecruiterLanguage.objects.filter(recruiter=self.recruiter).count(), 2
        )
    ...
    def test_update_language_not_owner(self):
        ...
        lang2 = RecruiterLanguage.objects.create(
            recruiter=self.recruiter2, language=self.lang_vi, proficiency_level="basic"
        )
    ...
    def test_delete_language_success(self):
        ...
        self.assertEqual(
            RecruiterLanguage.objects.filter(recruiter=self.recruiter).count(), 0
        )
