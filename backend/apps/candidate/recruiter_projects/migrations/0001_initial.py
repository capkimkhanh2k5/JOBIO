    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "project_name",
                    models.CharField(max_length=255, verbose_name="Tên dự án"),
                ),
                (
                    "description",
                ...
                (
                    "project_url",
                    models.URLField(
                        blank=True, max_length=500, null=True, verbose_name="URL dự án"
                    ),
                ),
                (
                    "start_date",
                ...
                (
                    "is_ongoing",
                    models.BooleanField(default=False, verbose_name="Đang thực hiện"),
                ),
                (
                    "technologies_used",
                    models.TextField(
                        blank=True, null=True, verbose_name="Công nghệ sử dụng"
                    ),
                ),
                (
                    "display_order",
