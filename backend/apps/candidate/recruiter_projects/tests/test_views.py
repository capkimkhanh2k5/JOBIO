...
class RecruiterProjectViewTest(APITestCase):
    ...
    def test_update_project_not_owner(self):
        ...
        proj2 = RecruiterProject.objects.create(
            recruiter=self.recruiter2, project_name="Other project", display_order=0
        )
    ...
    def test_delete_project_success(self):
        ...
        self.assertEqual(
            RecruiterProject.objects.filter(recruiter=self.recruiter).count(), 0
        )
    ...
    def test_reorder_projects_success(self):
        ...
        proj2 = RecruiterProject.objects.create(
            recruiter=self.recruiter, project_name="Second project", display_order=1
        )
