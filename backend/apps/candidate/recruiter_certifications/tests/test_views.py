...
class RecruiterCertificationViewTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.recruiter2 = Recruiter.objects.create(
            user=self.user2, bio="Test recruiter 2"
        )
    ...
    def test_create_certification_success(self):
        ...
        self.assertEqual(
            response.data["certification_name"], "Google Cloud Professional"
        )
    ...
    def test_update_certification_not_owner(self):
        ...
        cert2 = RecruiterCertification.objects.create(
            recruiter=self.recruiter2, certification_name="Other Cert", display_order=1
        )
    ...
    def test_reorder_certifications_success(self):
        ...
        cert2 = RecruiterCertification.objects.create(
            recruiter=self.recruiter, certification_name="Cert 2", display_order=2
        )
        cert3 = RecruiterCertification.objects.create(
            recruiter=self.recruiter, certification_name="Cert 3", display_order=3
        )
    ...
    def test_reorder_certifications_invalid_id(self):
        ...
        url = f"/api/candidates/{self.recruiter.id}/certifications/reorder/"
        data = {"order": [{"id": cert_other.id, "display_order": 1}]}
        response = self.client.patch(url, data, format="json")
