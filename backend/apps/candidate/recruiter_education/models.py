...
class RecruiterEducation(models.Model):
    ...
    degree = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Degree"
    )
    field_of_study = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Field of study"
    )
    start_date = models.DateField(
        null=True, blank=True, db_index=True, verbose_name="Start date"
    )
    end_date = models.DateField(null=True, blank=True, verbose_name="End date")
    is_current = models.BooleanField(default=False, verbose_name="Is current")
    gpa = models.DecimalField(
        max_digits=3, decimal_places=2, null=True, blank=True, verbose_name="GPA"
    )
