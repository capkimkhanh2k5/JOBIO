    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "school_name",
                    models.CharField(max_length=255, verbose_name="Tên trường"),
                ),
                (
                    "degree",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Bằng cấp"
                    ),
                ),
                (
                    "field_of_study",
                ...
                (
                    "is_current",
                    models.BooleanField(default=False, verbose_name="Đang học"),
                ),
                (
                    "gpa",
                    models.DecimalField(
