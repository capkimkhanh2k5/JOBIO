        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "years_of_experience",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Số năm kinh nghiệm"
                    ),
                ),
                (
                    "is_verified",
                ...
                (
                    "endorsement_count",
                    models.IntegerField(default=0, verbose_name="Số lượt xác nhận"),
                ),
                (
                    "last_used_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Ngày sử dụng gần nhất"
                    ),
                ),
                (
                    "created_at",
