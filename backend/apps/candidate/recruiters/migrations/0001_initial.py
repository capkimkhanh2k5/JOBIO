        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bio",
                    models.TextField(
                        blank=True, null=True, verbose_name="Giới thiệu bản thân"
                    ),
                ),
                (
                    "linkedin_url",
                ...
                (
                    "available_from_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Ngày có thể bắt đầu"
                    ),
                ),
                (
                    "years_of_experience",
                    models.IntegerField(
                        db_index=True, default=0, verbose_name="Số năm kinh nghiệm"
                    ),
                ),
                (
                ...
                (
                    "is_profile_public",
                    models.BooleanField(default=True, verbose_name="Hồ sơ công khai"),
                ),
                (
                    "profile_views_count",
                    models.IntegerField(default=0, verbose_name="Lượt xem hồ sơ"),
                ),
                (
                    "created_at",
