...
class Recruiter(models.Model):
    ...
    current_position = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Vị trí hiện tại"
    )
    ...
    linkedin_url = models.URLField(
        max_length=255, null=True, blank=True, verbose_name="LinkedIn URL"
    )
    facebook_url = models.URLField(
        max_length=255, null=True, blank=True, verbose_name="Facebook URL"
    )
    github_url = models.URLField(
        max_length=255, null=True, blank=True, verbose_name="GitHub URL"
    )
    ...
    years_of_experience = models.IntegerField(
        default=0, db_index=True, verbose_name="Số năm kinh nghiệm"
    )
