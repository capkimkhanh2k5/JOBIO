        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_current",
                    models.BooleanField(
                        default=False, verbose_name="Công việc hiện tại"
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True, null=True, verbose_name="Mô tả công việc"
                    ),
                ),
                (
                    "achievements",
                    models.TextField(blank=True, null=True, verbose_name="Thành tựu"),
                ),
                (
                    "display_order",
