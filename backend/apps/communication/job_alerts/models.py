...
class JobAlert(models.Model):
    ...
    keywords = models.TextField(null=True, blank=True, verbose_name="Từ khóa")
    ...
    skills = models.ManyToManyField(
        Skill, related_name="job_alerts", blank=True, verbose_name="Kỹ năng"
    )
    ...
    email_notification = models.BooleanField(
        default=True, verbose_name="Nhận email thông báo"
    )
    use_ai_matching = models.BooleanField(default=True, verbose_name="Sử dụng AI Match")
    last_sent_at = models.DateTimeField(
        null=True, blank=True, verbose_name="Gửi lần cuối"
    )
...
class JobAlertMatch(models.Model):
    ...
    matched_at = models.DateTimeField(
        auto_now_add=True, db_index=True, verbose_name="Thời điểm khớp"
    )
