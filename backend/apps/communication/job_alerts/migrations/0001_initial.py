    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alert_name",
                    models.CharField(max_length=255, verbose_name="Tên thông báo"),
                ),
                (
                    "keywords",
                    models.TextField(blank=True, null=True, verbose_name="Từ khóa"),
                ),
                (
                    "job_type",
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Gửi lần cuối"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="job_alerts",
                        to="geography_provinces.province",
