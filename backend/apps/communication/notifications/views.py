...
class NotificationViewSet(
    ...
    def mark_read(self, request, pk=None):
        ...
        """
        try:
            notification = mark_as_read(notification_id=pk, user_id=request.user.id)
            serializer = NotificationSerializer(notification)
            return Response(serializer.data)
    ...
    def bulk_mark_read(self, request):
        ...
        if read_all:
            ...
            updated_count = bulk_mark_as_read(
                notification_ids=notification_ids, user_id=request.user.id
            )
            message = f"{updated_count} notifications marked as read"

        return Response({"detail": message, "updated_count": updated_count})
    ...
    def destroy(self, request, pk=None):
        ...
        """
        try:
            delete_notification(notification_id=pk, user_id=request.user.id)
