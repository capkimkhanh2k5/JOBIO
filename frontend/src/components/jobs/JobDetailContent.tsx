    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <motion.section
                ...
                viewport={{ once: true }}
                className="bg-white rounded-2xl p-8 md:p-10 border border-gray-100 shadow-sm shadow-indigo-500/5 relative overflow-hidden group"
            >
            ...
            >
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">Yêu cầu ứng viên</h3>
                </div>
                <div
                    className="prose prose-slate max-w-none 
                    text-gray-600 leading-relaxed
            ...
            {benefits && (
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-xl font-bold text-gray-900">Quyền lợi</h3>
                    </div>
                    <div
                        className="grid grid-cols-1 md:grid-cols-2 gap-4"
                        dangerouslySetInnerHTML={{
                            __html: benefits.replace(/<li>/g, '<div class="flex items-start gap-3 p-4 rounded-xl bg-gray-50 border border-gray-100 hover:bg-white hover:border-emerald-200 transition-all group/benefit"><span class="flex-shrink-0 w-8 h-8 rounded-lg bg-emerald-100/50 flex items-center justify-center text-emerald-600 group-hover/benefit:scale-110 transition-transform"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"></path></svg></span><p class="text-sm font-semibold text-gray-700">')
                                .replace(/<\/li>/g, '</p></div>')
                                .replace(/<ul>/g, '')
                                .replace(/<\/ul>/g, '')
                        }}
