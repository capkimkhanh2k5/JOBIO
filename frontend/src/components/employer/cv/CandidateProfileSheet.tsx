                        ...
                        <div className="space-y-8 mt-2 pb-8">
                                    ...
                                    {(profile.experiences || profile.experience || []).map((exp: any) => (
                                        <div key={exp.id} className="relative pl-6 before:absolute before:left-[11px] before:top-2 before:bottom-[-24px] before:w-px before:bg-border last:before:hidden">
                                            ...
                                            <div className="bg-card border border-border/50 rounded-xl p-4 shadow-sm hover:border-primary/20 transition-colors">
                                                ...
                                                <p className="text-sm font-medium text-primary mt-1">{exp.company_name || exp.company}</p>
                            ...
                            <section>
                                ...
                                <div className="grid sm:grid-cols-2 gap-3">
                                    ...
                                    <a href={profile.linkedin_url || profile.social_links?.linkedin || '#'} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-lg border border-border/50 bg-card hover:bg-muted/50 hover:border-primary/30 transition-colors group">
                                    ...
                                    <a href={profile.github_url || profile.social_links?.github || '#'} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-lg border border-border/50 bg-card hover:bg-muted/50 hover:border-primary/30 transition-colors group">
