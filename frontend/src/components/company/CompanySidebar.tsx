...
export function CompanySidebar() {
    ...
    const checkIsActive = (path: string) => {
        ...
        if (path === '/company/jobs') {
            return location.pathname === path || (location.pathname.startsWith(path) && !location.pathname.startsWith('/company/jobs/create'));
        }
        ...
        >
            ...
            <div className="flex-1 pt-6 pb-4 flex flex-col gap-1 overflow-y-auto">
                ...
                <div className="px-3 mb-2">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400 px-3">COMPANY PANEL</p>
                </div>
