            ...
            <div className="space-y-4">
                <div className="flex justify-center gap-2">
                    <Input
                        ...
                        className="bg-white/5 border-white/10 focus:border-cyan-500/50 h-12 text-center text-xl tracking-widest max-w-[240px]"
                        value={token}
                ...
                <div className="pt-4">
                    ...
                    <Button
                        variant="link"
                        className="text-cyan-600 hover:text-cyan-700 p-0 h-auto font-bold"
