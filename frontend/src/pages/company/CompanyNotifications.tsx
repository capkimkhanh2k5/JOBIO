...
// ─── Type metadata for company-specific notification types ────────────────────
...
export default function CompanyNotifications() {
    ...
    const queryParams = (() => {
        ...
        if (['application', 'interview', 'verification', 'billing', 'system'].includes(activeTab)) p.type = activeTab;
    ...
    const { data, isLoading } = useQuery({
        queryKey: ['company-notifications', activeTab, page, debouncedSearch],
                ...
                <PageHeader
                    ...
                    description={
                        unreadCount > 0
                            ...
                            : 'Quản lý thông báo ứng tuyển, phỏng vấn, xác minh và thanh toán'
                    }
                    icon={Bell}
                />
            </div>
