    ...
    return (
        <div className="min-h-screen overflow-hidden relative">
            ...
            <div className="w-full mx-auto space-y-8 relative z-10 p-6 lg:p-8 animate-in fade-in duration-700">
                {/* Clean Integrated Header - Replaces the bulky PageHeader for better consistency */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex flex-col">
                        ...
                        <p className="mt-4 text-base md:text-lg text-slate-500 max-w-3xl font-medium leading-relaxed">
                            Chúng tôi luôn sẵn sàng hỗ trợ bạn giải quyết mọi vấn đề trong quá trình sử dụng hệ thống.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            >
                                ...
                                <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm px-8 divide-y divide-slate-100">
                                    {faqs.map((faq, idx) => (
                        ...
                        <div className="space-y-8">
                            ...
                            <motion.div 
                                ...
                                className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-[2rem] p-8 text-white overflow-hidden relative group shadow-2xl shadow-slate-900/20"
                            >
                            ...
                            <motion.div
                                ...
                                className="p-6 rounded-[2rem] bg-violet-50 border border-violet-100/50 text-center"
                            >
