    ...
    return (
        <div className="p-6 md:p-8 max-w-5xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-slate-500 mt-1">Quản lý và theo dõi các vị trí bạn quan tâm ({savedJobs?.length || 0})</p>
            </div>
            ...
            {savedJobs?.length === 0 ? (
                <div className="text-center py-16 bg-white rounded-3xl border border-slate-200">
                    ...
                    <Link to="/jobs">
                        <Button className="bg-gradient-to-r from-violet-600 to-cyan-600 text-white rounded-xl shadow-md hover:shadow-lg transition-all">
                            Tìm việc ngay
                                    ...
                                    <div className="p-6 flex flex-col md:flex-row gap-6">
                                        ...
                                        <div className="flex md:flex-col items-center gap-3 shrink-0 pt-1">
                                            <Link to={`/jobs/${job.job_id}`} className="w-full md:w-auto flex-1">
                                                <Button className="w-full bg-gradient-to-r from-violet-600 to-cyan-600 hover:opacity-90 text-white rounded-xl shadow-md hover:shadow-lg transition-all">
